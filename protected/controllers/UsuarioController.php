...
class UsuarioController extends Controller {
     ...
     * Si un usuario intenta eliminar sus propios credenciales, se cancelará la acción y se mostrará un error
     * @param integer $id the ID of the model to be deleted
     */
    public function actionDelete($id) {
        if ($id === Yii::app()->user->getId()) {
            throw new CHttpException(403, 'No está autorizado a eliminar su propio usuario.');
        } else {
