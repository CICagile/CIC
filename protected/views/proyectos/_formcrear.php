<div class="form">
    ...
    <div class="row">
        ...
        <?php
        echo $form->dropDownList($modelproyectos, 'idtbl_sectorbeneficiado', CHtml::listData(SectorBeneficiado::model()->findAll(), 'idtbl_sectorbeneficiado', 'nombre'), array('empty' => 'Elija el sector beneficiado', 'id' => 'Proyectos_idtbl_sectorbeneficiado'))
        ?>
