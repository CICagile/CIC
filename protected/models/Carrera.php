...
/**
 * This is the model class for table "tbl_carreras".
 *
 * The followings are the available columns in table 'tbl_carreras':
...
class Carrera extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idtbl_Carreras, nombre', 'safe', 'on'=>'search'),
		);
	}
